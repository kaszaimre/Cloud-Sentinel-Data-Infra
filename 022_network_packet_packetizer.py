# ==============================================================================
# FÁJL NÉV: 022_network_packet_packetizer.py
# SORSZÁM: 022
#
# LEÍRÁS ÉS FELADAT:
# Alacsony szintű hálózati csomag-összeállító (packetizer) és elemző modul. 
# A kód egyéni fejléc-struktúrákat (headers) és ellenőrző összegeket (checksum) 
# számol ki, amellyel a Cyber-Borsod protokoll adatcsomagjait validálja és 
# készíti fel a hálózati továbbításra.
# ==============================================================================
