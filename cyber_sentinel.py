...
def riaszto_email_kuldes(pid, process_name, indok):
    msg = MIMEMultipart()
...
Folyamat részletei:
  - PID: {pid}
  - Futtatott parancs/Image: {process_name}
...
def folyamat_ellenorzes():
    try:
        # Windows tasklist lekérése CSV formátumban
        ...
        for sor in sorok:
            ...
            if incidens:
                try:
                    ...
                    log_event(alert_msg)
                    riaszto_email_kuldes(pid, process_name, indok)
